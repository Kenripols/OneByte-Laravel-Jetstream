    ...
    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Dueño</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nacimiento</th>
        ...
        <tbody class="bg-white divide-y divide-gray-100">
            @forelse ($pets as $pet)
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 text-sm text-gray-500">{{ $pet->id }}</td>

                    <td class="px-6 py-4 text-sm font-semibold text-blue-600 cursor-pointer hover:underline"
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center py-6 text-gray-400">No se encontraron mascotas</td>
                </tr>
            @endforelse
        </tbody>
    </table>
