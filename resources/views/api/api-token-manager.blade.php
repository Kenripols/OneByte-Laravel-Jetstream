<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="description">
            {{ __('Los API tokens permiten que servicios de terceros se autentiquen con nuestra aplicación en tu nombre.') }}
        </x-slot>
    ...
    <x-dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            <div>
                {{ __('Por favor, copia tu nuevo API token. Por tu seguridad, no se volverá a mostrar.') }}
            </div>
