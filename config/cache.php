...
return [
    ...
    */
    ...
    | así como sus controladores. Incluso puedes definir múltiples almacenes para
    | el mismo controlador de caché con el fin de agrupar los tipos de elementos
    | almacenados en tus cachés.
    |
    | Controladores compatibles: "array", "database", "file", "memcached",
    ...
    */
    ...
    | es posible que otras aplicaciones utilicen la misma caché. Por
    | ese motivo, puedes añadir un prefijo a cada clave de caché para evitar colisiones.
    |
    */
